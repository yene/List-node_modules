...
- (BOOL)tableView:(NSTableView *)aTableView writeRowsWithIndexes:(NSIndexSet *)rowIndexes toPasteboard:(NSPasteboard *)pboard {
	...
	// NSPasteboardTypeFileURL [pboard declareTypes:[NSArray arrayWithObject:NSFilenamesPboardType] owner:nil];
	//[pboard setPropertyList:rowSelection forType:NSFilenamesPboardType];
	// NSPasteboardTypeURL
	//[pboard declareTypes:[NSArray arrayWithObject:NSPasteboardTypeURL] owner:nil];
	//[pboard writeObjects:rowSelection]; NSURLPboardType
	
	//[pboard setPropertyList:fileList forType:NSFilenamesPboardType];
	/*
	[pboard declareTypes:[NSArray arrayWithObject:NSPasteboardTypeURL] owner:nil];
	for (NSURL *path in rowSelection) {
		[path writeToPasteboard:pboard];
	}*/
